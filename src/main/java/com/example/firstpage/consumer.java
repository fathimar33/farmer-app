...
public class consumer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isValid) {
                    Intent view1 = new Intent(getApplicationContext(),terms_cond2.class);
                    startActivity(view1);
                }
            }
            else {
                    Toast.makeText(consumer.this, "password must be numeric", Toast.LENGTH_SHORT).show();}
            }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent view3= new Intent(getApplicationContext(),login1.class);
                startActivity(view3);
            }
        });
    ...
    private boolean validateinfo(String name,String password,Integer cw,String pswd,Integer cw1) {
        if (name.isEmpty()) {
            Toast.makeText(consumer.this, "username must not be empty", Toast.LENGTH_SHORT).show();
            et1.setError("enter the required field");
            return false;
        } else if (password.length()<8) {
            Toast.makeText(consumer.this, "password must be at least 8 characters", Toast.LENGTH_SHORT).show();
